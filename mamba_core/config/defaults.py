...
# SSD augmentation
_C.INPUT.ENABLE_SSD_AUG = False
_C.INPUT.USE_SELSA_CODE = False
...
# ---------------------------------------------------------------------------- #
# SwinTransformer Options (Follow the Detectron version)
# ---------------------------------------------------------------------------- #
...
_C.MODEL.VID.MAMBA.PIX_MEM.SCORE_THRESH = 0.8
...
_C.MODEL.VID.MAMBA.PIX_MEM.GEO.IN_CHANNELS = 1024
_C.MODEL.VID.MAMBA.PIX_MEM.GEO.EMB_CHANNELS = 1024
...
_C.MODEL.VID.MAMBA.INS_MEM.ENABLE = False
_C.MODEL.VID.MAMBA.INS_MEM.NUM_ENHANCEMENT = 2
...
_C.SOLVER.ADAMW.WEIGHT_DECAY = 0.05
_C.SOLVER.ADAMW.LR = 0.0001
...
# Debug
_C.TEST.DEBUG = CN()
_C.TEST.DEBUG.LEVEL = 0
_C.TEST.DEBUG.PAUSE = False
