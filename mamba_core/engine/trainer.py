...
from mamba_core.utils.comm import get_world_size, synchronize
from mamba_core.utils.metric_logger import MetricLogger
...
def do_train(
    ...
    logger = logging.getLogger("mamba_core.trainer")
    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        if iteration == max_iter:
            ...
            # save pure model
            checkpointer.save_pure_model("model_last_pure")
