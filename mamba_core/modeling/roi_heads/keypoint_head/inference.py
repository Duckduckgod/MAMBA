...
from mamba_core.structures.keypoint import PersonKeypoints
...
def heatmaps_to_keypoints(maps, rois):
    ...
    Output has shape (#rois, 4, #keypoints) with the 4 rows corresponding to
    (x, y, logit, prob) for each keypoint.
    """
