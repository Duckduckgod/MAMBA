...
import os
import sys
from mamba_core.utils.comm import is_main_process, synchronize
...
def cache_url(url, model_dir=None, progress=True):
    ...
    Example:
        >>> cached_file = mamba_core.utils.model_zoo.cache_url('https://s3.amazonaws.com/pytorch/models/resnet18-5c106cde.pth')
    """
